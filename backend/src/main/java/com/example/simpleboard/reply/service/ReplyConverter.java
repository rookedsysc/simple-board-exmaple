...
public class ReplyConverter implements Converter<ReplyDto, ReplyEntity> {
  ...
  public ReplyDto toDto(ReplyEntity replyEntity) {
    return ReplyDto.builder()
        ...
        .postId(replyEntity.getPost()
            .getId())
        .status(replyEntity.getStatus() != null ? replyEntity.getStatus() : "REGISTERED")
        .title(replyEntity.getTitle())
        .content(replyEntity.getContent())
        .userName(replyEntity.getUserName())
        .password(replyEntity.getPassword())
        .repliedAt(replyEntity.getRepliedAt() != null ? replyEntity.getRepliedAt() : LocalDateTime.now())
        .build();
  }
